...
BACKUP_CONF = {
    ...
    "device_mapping": {
        "switch": (
            "dumper",
            SSH_CONF.get("switch_con_host"),
            SSH_CONF.get("failed_backup_file"),
            HOST_PORTABLE,
        ),
        "digi": (
            "digi",
            TELNET_CONF.get("digi_con_host"),
            TELNET_CONF.get("failed_backup_file"),
            DIGI_HOST_PORTABLE,
        ),
    },
}
